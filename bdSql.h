...
#define CREATE_TABLE_CANALES "CREATE TABLE Canales (Ip TEXT NOT NULL,Tiempo REAL NOT NULL,NumPaq INT NOT NULL,NumPer INT NOT NULL,Ret REAL NOT NULL,RetC REAL NOT NULL,NumErr INT NOT NULL,Bytes INT NOT NULL)"

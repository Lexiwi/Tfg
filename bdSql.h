...
#define CREATE_TABLE_CANALES "CREATE TABLE Canales (Ip TEXT NOT NULL,Tiempo REAL NOT NULL,NumPaq INT NOT NULL,NumPaqDif INT NOT NULL, NumPer INT NOT NULL,NumPerDif INT NOT NULL, PorPer INT NOT NULL,PorPerDif INT NOT NULL, Ret REAL NOT NULL,RetDif REAL NOT NULL,RetC REAL NOT NULL,NumErr INT NOT NULL,NumErrDif INT NOT NULL,Bytes INT NOT NULL,BytesDiff INT NOT NULL,Jitter REAL NOT NULL,Moss REAL NOT NULL,Tipo INT NOT NULL)"
...
#define CREATE_TABLE_CLIENTES "CREATE TABLE Clientes (Ip TEXT NOT NULL,Cliente TEXT NOT NULL, Tiempo REAL NOT NULL, Moss REAL NOT NULL)"
